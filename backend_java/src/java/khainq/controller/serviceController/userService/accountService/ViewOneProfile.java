 ...
 */
public class ViewOneProfile extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (role.equals("admin") || role.equals("user")) {
                ...
                Tbl_AccountsDTO account = dao.viewAccountDetail(user.getUsername());
                
                String json = gson.toJson(account);
                pw.append(json);
            }
        } catch (Exception e) {
            log("ERROR at ViewOneProfile controller: " + e.getMessage());
        }
