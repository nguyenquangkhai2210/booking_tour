 ...
 */
public class GetOneOrderOfAdmin extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (role.equals("admin")) {
                ...
                Tbl_OrderDTO orderDTO = orderDAO.getOneOrderOfAdmin(dto.getId());
            ...
            log("ERROR at GetOneOrderOfAdmin controller: " + e.getMessage());
