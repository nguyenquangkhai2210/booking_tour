 ...
 */
package khainq.controller.serviceController.adminService.orderService;
 ...
 */
public class GetListOrderOfAdmin extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Tbl_OrderDTO orderDTO = gson.fromJson(jsonBody, Tbl_OrderDTO.class);
        ...
        try {
            if (role.equals("admin")) {
                ...
                List<Tbl_OrderDTO> listOrder = orderDAO.getListOrderOfAdmin(orderDTO.getStatus(), orderDTO.getCreatedTime(), orderDTO.getLastUpdate());
            ...
            log("ERROR at GetListOrderOfAdmin controller: " + e.getMessage());
