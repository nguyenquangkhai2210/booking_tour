 ...
 */
public class GetAllTourAdmin extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Tbl_ToursDTO tourDTO = gson.fromJson(jsonBody, Tbl_ToursDTO.class);
        try {
            Tbl_ToursDAO dao = new Tbl_ToursDAO();

            List<Tbl_ToursDTO> listTour = dao.getListToursAll(tourDTO.getCategoryId());
            ...
            log("ERROR at GetAllTourAdmin controller: " + e.getMessage());
